...
organized by
[O’Reilly](https://www.safaribooksonline.com/live-training/courses/beginning-r-programming/0636920245025/).
...
``` r
newProject <- usethis::use_course('https://github.com/jaredlander/LiveBeginnerFebruary2019/archive/master.zip')
```
...
LiveBeginnerFebruary2019. You can see this in the top right of RStudio
